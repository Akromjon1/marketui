  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.notifications_none, color: Colors.deepOrange,),
            onPressed: () {  },
          ),
          IconButton(
  ...
  Widget makeItem(String image){
    return Container(
      ...
      child: Container(
        ...
        //               SizedBox(height: 20,),
        //               Text("Electric", style: TextStyle(fontSize: 20, color: Colors.white),),
        //
        //             ],
        //           ),
        //         ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 20,),
                    Text("Electric", style: TextStyle(fontSize: 20, color: Colors.deepOrange,fontWeight: FontWeight.bold),),
                  ],
                ),
                Text("100\$",style: TextStyle(color: Colors.white, fontSize: 25,fontWeight: FontWeight.bold),),
              ],
